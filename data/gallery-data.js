window.siteLeaders = [
    { name: "Sheikh Ali bin Alnuaimi", title: "Honorary Chairman" },
    { name: "Sheikh Mohammed bin Hamdan Al Nahyan", title: "Board Chairman" },
    { name: "Mr. Youssuf", title: "Secretary General" },
    { name: "Sheikh Hamdan bin Ahmed Al Maktoum", title: "Strategic Advisor" }
];
...
window.siteGallery = [
    ...
    { image: "images/royal9.jpg", alt: "Royal engagement event" }
];
